...
if __name__ == '__main__':
    ...
    # dataset
    parser.add_argument('--dataset', default='mimic', type=str, help='which dataset', choices=['mimic', 'vindr'])
    ...
    if args.dataset == 'mimic':
        ...
        test_dataset = VinBrain_Dataset(
            imgpath=im_path, 
            csvpath=args.data_dir + "test.csv",#"mimic-cxr-2.0.0-chexpert.csv.gz",
            # metacsvpath=args.data_dir + "test_main_file_v2.csv",#"mimic-cxr-2.0.0-metadata.csv.gz",
            # splitpath = args.data_dir + "mimic-cxr-2.0.0-split.csv.gz", 
            split = 'test', 
            tag = args.tag,
            transform=None, data_aug=data_aug, unique_patients=False, views=["AP"], healthy = args.healthy
            )

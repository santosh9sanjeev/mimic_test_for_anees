...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/home/aneeshashmi/generative/xray_classification/vindr/annotations/vindr_rsna/', type=str, help='csv file containing the stats')
    parser.add_argument('--output_dir', default='/share/nvmedata/anees_ckpt/classification/vindr', type=str, help='Model save path')
    parser.add_argument('--checkpoint_path', default='/share/ssddata/santosh_models/MIMIC-densenet-best.pt', type=str, help='checkpoint path')
    parser.add_argument('--dataset_name', default='vindr', type=str, help='which dataset')
    ...
    parser.add_argument('--num_workers', default=z, type=int)
    ...
    ckpt = torch.load(args.checkpoint_path).state_dict()
